<?php /* Smarty version Smarty-3.1.21, created on 2015-12-23 15:47:15
         compiled from "C:\wamp\www\udo\application\views\account\getorder.phtml" */ ?>
<?php /*%%SmartyHeaderCode:22528567a16810c9988-08310317%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2be93fe94889857e6c0d1fc39ac722e72d62c312' => 
    array (
      0 => 'C:\\wamp\\www\\udo\\application\\views\\account\\getorder.phtml',
      1 => 1450855399,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '22528567a16810c9988-08310317',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_567a16812b6966_82553872',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_567a16812b6966_82553872')) {function content_567a16812b6966_82553872($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="well" style="overflow: auto">
                        ...
                        <div class="col-md-3">
                            <select class="form-control">
                                <option>全部</option>
                                <?php  $_smarty_tpl->tpl_vars['sta'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['sta']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['status']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sta']->key => $_smarty_tpl->tpl_vars['sta']->value) {
$_smarty_tpl->tpl_vars['sta']->_loop = true;
?>
                                <option><?php echo $_smarty_tpl->tpl_vars['sta']->value['name'];?>
</option>
                                <?php } ?>
                            </select>
                        </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['payType']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['type']->key => $_smarty_tpl->tpl_vars['type']->value) {
$_smarty_tpl->tpl_vars['type']->_loop = true;
?>
                                <option><?php echo $_smarty_tpl->tpl_vars['type']->value['name'];?>
</option>
                                <?php } ?>
                            </select>
                        </div>
...
?>
                        <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $_smarty_tpl->tpl_vars['order']->value['id'];?>
</td>
                            <td class=" "><?php echo $_smarty_tpl->tpl_vars['order']->value['createTime'];?>
 </td>
                            <td class=" "><?php echo $_smarty_tpl->tpl_vars['order']->value['userId'];?>

                            </td>
                            <td class=" "><?php echo $_smarty_tpl->tpl_vars['order']->value['mobile'];?>
</td>
                            <td class=" "><?php echo $_smarty_tpl->tpl_vars['order']->value['payType'];?>
</td>
                            <td class="a-right a-right "><?php echo $_smarty_tpl->tpl_vars['order']->value['status'];?>
</td>
                            <td class = ""><?php echo $_smarty_tpl->tpl_vars['order']->value['amount'];?>
</td>
                            <td class = ""><?php echo $_smarty_tpl->tpl_vars['order']->value['coinId'];?>
</td>
                            <td>
                                <?php if ($_smarty_tpl->tpl_vars['order']->value['resource']) {?>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm-<?php echo $_smarty_tpl->tpl_vars['order']->value['no'];?>
">查看购买资源</button>
                                <!-- 模块框-->
                                <div class="modal fade bs-example-modal-sm-<?php echo $_smarty_tpl->tpl_vars['order']->value['no'];?>
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <h4><?php echo $_smarty_tpl->tpl_vars['order']->value['schoolName'];?>
-<?php echo $_smarty_tpl->tpl_vars['order']->value['schoolTitle'];?>
下的<?php echo $_smarty_tpl->tpl_vars['order']->value['courseCount'];?>
门课程</h4>
                                                <?php  $_smarty_tpl->tpl_vars['res'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['res']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['order']->value['resource']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['res']->key => $_smarty_tpl->tpl_vars['res']->value) {
$_smarty_tpl->tpl_vars['res']->_loop = true;
?>
                                                <p><?php echo $_smarty_tpl->tpl_vars['res']->value['resourceName'];?>
</p>
                                                <?php } ?>
                                                <!--<?php echo $_smarty_tpl->tpl_vars['order']->value['resource'];?>
-->
                                            </div>
